...
public class StatementUtils {
    ...
    public static GenericRet createControl(ControlType controlType, String startIdent, String endIdent,
                                           ExpressionInterface condition, StatementInterface statement) throws TypeException {
        return createControl(controlType, startIdent, endIdent, condition, statement, null, null);
    }

    public static GenericRet createControl(ControlType controlType, String startIdent, String endIdent,
                                           ExpressionInterface condition, StatementInterface statement,
                                           String altIdent, StatementInterface altStatement) throws TypeException {
